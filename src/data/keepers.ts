...
export const keepers: GardenKeeper[] = [
  { id: 'mosslight', name: '苔光 Mosslight', avatar: '/images/keeper/01-forest-sprout.png', personality: '温暖治愈型', description: '像林间苔光一样安静守候，让项目按照自己的节奏生长。', tone: '温暖、耐心、接纳，用轻柔的问题陪用户看见变化。', recommendedUse: '陪伴项目成长' },
  ...
  { id: 'rainelle', name: '雨弦 Rainelle', avatar: '/images/keeper/03-cyan-rain.png', personality: '观察分析型', description: '倾听每一段生长记录，像雨线一样梳理项目留下的轨迹。', tone: '冷静、细致、有条理，以观察为先，不急于下结论。', recommendedUse: '帮助复盘项目' },
  { id: 'coralia', name: '珊芽 Coralia', avatar: '/images/keeper/04-coral-mushroom.png', personality: '实验探索型', description: '在陌生土壤中寻找新的生长可能，喜欢小规模、可感知的实验。', tone: '大胆、开放、富有想象力，鼓励尝试但尊重项目边界。', recommendedUse: '鼓励新方向' },
  ...
  { id: 'ember', name: '焰芽 Ember', avatar: '/images/keeper/06-orange-light-run.png', personality: '行动推进型', description: '把积蓄的能量变成一簇可行动的火苗，陪项目迈出清晰的一步。', tone: '直接、明亮、有鼓舞感，聚焦当下最小可行行动。', recommendedUse: '帮助进入下一步' },
]
